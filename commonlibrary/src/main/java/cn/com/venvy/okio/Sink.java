 ...
 *
 * <p>
 * Sinks are easy to test: just use a {@link Buffer} in your tests, and read
 * from it to confirm it received the data that was expected.
 *
 * <h3>Comparison with OutputStream</h3> This interface is functionally
 * equivalent to {@link java.io.OutputStream}.
 *
 * <p>
 ...
 * {@linkplain java.io.OutputStream#write(int) single-byte write} method that is
 * awkward to implement efficiently.
 *
 * <h3>Interop with OutputStream</h3> Use {@link Okio#sink} to adapt an
 * {@code OutputStream} to a sink. Use {@link BufferedSink#outputStream} to
 * adapt a sink to an {@code OutputStream}.
 */
public interface Sink extends Closeable, Flushable {
	/**
	 * Removes {@code byteCount} bytes from {@code source} and appends them to
	 * this.
	 */
