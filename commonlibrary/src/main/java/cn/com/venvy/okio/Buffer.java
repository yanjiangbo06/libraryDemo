...
import static cn.com.venvy.okio.Util.checkOffsetAndCount;
import static cn.com.venvy.okio.Util.reverseBytesLong;
...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
	...
	public long readLong() {
		...
		long v = (data[pos++] & 0xffL) << 56 | (data[pos++] & 0xffL) << 48 | (data[pos++] & 0xffL) << 40
				| (data[pos++] & 0xffL) << 32 | (data[pos++] & 0xffL) << 24 | (data[pos++] & 0xffL) << 16
	...
	/**
	 * Returns the index of a value in {@code options} that is either the prefix
	 * of this buffer, or that this buffer is a prefix of. Unlike
	 * {@link #select} this never consumes the value, even if it is found in
	 * full.
	 */
