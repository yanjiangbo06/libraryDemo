...
public class HttpRequest extends Request {
    ...
    public static HttpRequest get(String url, Map<String, String> headers, Map<String, String> params, RequestCacheType defaultCacheType) {
    ...
    public static HttpRequest post(String url, Map<String, String> headers, Map<String, String> params, RequestCacheType defaultCacheType) {
    ...
    public static HttpRequest delete(String url, Map<String, String> headers, Map<String, String> params, RequestCacheType defaultCacheType) {
