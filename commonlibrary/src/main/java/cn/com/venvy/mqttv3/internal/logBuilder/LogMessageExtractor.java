 ...
 */
package cn.com.venvy.mqttv3.internal.logBuilder;
...
public class LogMessageExtractor {
	...
	public static void main(String[] args) {
		...
		//cn.com.venvy.client.mqttv3
		// Set defaults by assuming this is run from an eclipse workspace with paho projects loaded
		String dir = "../cn.com.venvy.client.mqttv3/src";
		String file = dir+"/cn/com/videopls/venvy/client/mqttv3/internal/nls/logcat.properties";
	...
	private static void usageAndExit() {
		System.out.println("usage:\n cn.com.venvy.client.mqttv3.internal.trace.TracePointExtractor [-d baseDir] [-o outputFile]");
