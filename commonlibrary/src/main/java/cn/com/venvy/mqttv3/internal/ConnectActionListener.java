...
import cn.com.venvy.mqttv3.IMqttActionListener;
import cn.com.venvy.mqttv3.IMqttToken;
import cn.com.venvy.mqttv3.MqttAsyncClient;
...
public class ConnectActionListener implements IMqttActionListener {
	...
	public ConnectActionListener(MqttAsyncClient client,
			MqttClientPersistence persistence, ClientComms comms,
			MqttConnectOptions options, MqttToken userToken,
			Object userContext, IMqttActionListener userCallback) {
	...
	public void onFailure(IMqttToken token, Throwable exception) {
		...
		if ((index + 1) < numberOfURIs
				|| (originalMqttVersion == MqttConnectOptions.MQTT_VERSION_DEFAULT && options
						.getMqttVersion() == MqttConnectOptions.MQTT_VERSION_3_1_1)) {
