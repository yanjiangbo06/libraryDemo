...
class ViewPropertyAnimatorHC extends ViewPropertyAnimator {
 ...
 (HashMap<Animator, PropertyBundle>) mAnimatorMap
					.clone();
 ...
 (ArrayList<NameValuesHolder>) mPendingAnimations
     ...
     */
    @SuppressLint("NewApi") private void setValue(int propertyConstant, float value) {
     ...
     */
    @SuppressLint("NewApi") private float getValue(int propertyConstant) {
        //final View.TransformationInfo info = mView.mTransformationInfo;
        View v = mView.get();
        if (v != null) {
            switch (propertyConstant) {
