 ...
 */
package cn.com.venvy.nineoldandroids.util;
 ...
 * pair, given the specification of {@link Property#of(Class, Class, String)}
 */
class ReflectiveProperty<T, V> extends Property<T, V> {
	 ...
	 */
	private boolean typesMatch(Class<V> valueType,
			@SuppressWarnings("rawtypes") Class getterType) {
