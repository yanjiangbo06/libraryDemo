...
package cn.com.venvy.nineoldandroids.animation;
...
import cn.com.venvy.nineoldandroids.util.FloatProperty;
import cn.com.venvy.nineoldandroids.util.IntProperty;
import cn.com.venvy.nineoldandroids.util.Property;
...
public class PropertyValuesHolder implements Cloneable {
	 ...
	 */
	private PropertyValuesHolder(@SuppressWarnings("rawtypes") Property property) {
		mProperty = property;
		if (property != null) {
	...
	private Method getPropertyFunction(
			@SuppressWarnings("rawtypes") Class targetClass, String prefix,
			@SuppressWarnings("rawtypes") Class valueType) {
...
//					VenvyLog.e("PropertyValuesHolder",
...
//									+ mPropertyName + ": " + e);
			...
			Class typeVariant : typeVariants) {
				args[0] = typeVariant;
				try {
					returnVal = targetClass.getMethod(methodName, args);
...
//							+ " with value type " + mValueType);
		...
		for (Keyframe kf : mKeyframeSet.mKeyframes) {
			if (!kf.hasValue()) {
				...
				try {
					...
					//VenvyLog.e("PropertyValuesHolder", e.toString());
	...
	public void setEvaluator(
			@SuppressWarnings("rawtypes") TypeEvaluator evaluator) {
	...
	static class IntPropertyValuesHolder extends PropertyValuesHolder {
		...
		void setupSetter(@SuppressWarnings("rawtypes") Class targetClass) {
			...
			// VenvyLog.d("PropertyValuesHolder",
