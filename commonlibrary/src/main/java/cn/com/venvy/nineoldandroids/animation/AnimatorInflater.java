...
public class AnimatorInflater {
	...
	private static Animator createAnimatorFromXml(Context c,
		...
		while (((type = parser.next()) != XmlPullParser.END_TAG || parser
			...
			if (name.equals("objectAnimator")) {
				...
				a.getValue(
				/* com.android.internal.R.styleable. */AnimatorSet_ordering,
						orderingValue);
	...
	private static ObjectAnimator loadObjectAnimator(Context context,
		...
		String propertyName = a
				.getString(/* com.android.internal.R.styleable. */PropertyAnimator_propertyName);
	...
	private static ValueAnimator loadAnimator(Context context,
		...
		/* com.android.internal.R.styleable. */Animator_valueType,
				VALUE_TYPE_FLOAT);
		...
		if (a.hasValue(/* com.android.internal.R.styleable. */Animator_repeatCount)) {
			anim.setRepeatCount(a
					.getInt(/* com.android.internal.R.styleable. */Animator_repeatCount,
							0));
		}
		if (a.hasValue(/* com.android.internal.R.styleable. */Animator_repeatMode)) {
			anim.setRepeatMode(a.getInt(
			/* com.android.internal.R.styleable. */Animator_repeatMode,
